...
export async function execute(interaction: CommandInteraction) {
	...
	console.log(`${targetName}, ${preferredName} wants you to change your name to ${nickname.substring(0,32)}`);
	console.log(`${user.id}, ${nickname}, ${Date.now()}, ${interaction.user.id}`);
